...
namespace Medinova.Areas.Admin.Controllers
{
    ...
    public class AdminAboutItemController : Controller
    {
        ...
        public AdminAboutItemController()
        {
            _context = new MedinovaContext();
            _repo = new GenericRepository<AboutItem>(_context);
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(AboutItem model)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(AboutItem model)
        {
            if (ModelState.IsValid)
            {
